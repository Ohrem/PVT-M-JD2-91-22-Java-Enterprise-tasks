...
public class TestDao {
    ...
    public void findById() {
        User user = targetObject.findById(13L);
    ...
    public void delete() {
        ...
        User user = targetObject.findById(14);
        assertNotNull(user);
        //When
    ...
    public void create() {
        ...
        User user = User.builder()
                .personalInfo(PersonalInfo.builder().firstname("Timofey")
                        .lastname("Liskovey").birthDate(new BirthDay(LocalDate.of(1981, 6, 20)))
    ...
    public void update() {
        ...
        //Then
        User user1 = targetObject.findById(10);
